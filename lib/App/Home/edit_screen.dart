                ...
                onPressed: () async {
                  if (formKey.currentState!.validate()) {
                    ...
                    if (widget.isFromEdit) {
                      ...
                      addNewCard(() {
                        // Get.back();
                        Timer(Duration(milliseconds: 1500), () => Get.offAll(() => HomeScreen()));
                      });
                    }
                  }
                },
                icon: showProgress.value
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      leading: Container(
                        ...
                        decoration: BoxDecoration(color: colorPrimary, borderRadius: BorderRadius.circular(100)),
                        child: Image(
                          image: getImage(index: index, fieldName: kHomeController.addFieldsModelList[index]['title']),
                          color: colorWhite,
                        ),
                      ),
                      title: Text(
